import React__default, { Component, cloneElement, createElement, Children, PureComponent, Fragment } from 'react';
...
var scrollDroppable = function scrollDroppable(droppable, newScroll) {
  !droppable.viewport.closestScrollable ? process.env.NODE_ENV !== "production" ? index(false) : index(false) : void 0;
...
var getSafeClipped = function getSafeClipped(droppable) {
  ...
  !rect ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot get clipped area from droppable') : index(false) : void 0;
  return rect;
};
...
var toHomeList = (function (_ref) {
  ...
  !(targetIndex !== -1) ? process.env.NODE_ENV !== "production" ? index(false, 'Unable to find target in destination droppable') : index(false) : void 0;
...
var toForeignList = (function (_ref) {
  ...
  var targetIndex = insideDestination.indexOf(movingRelativeTo);
  !(targetIndex !== -1) ? process.env.NODE_ENV !== "production" ? index(false, 'The target was not found within its droppable') : index(false) : void 0;
...
var moveToNewDroppable = (function (_ref) {
  ...
  if (destination.descriptor.id === draggable.descriptor.droppableId) {
    !movingRelativeTo ? process.env.NODE_ENV !== "production" ? index(false, 'There will always be a target in the original list') : index(false) : void 0;
    return toHomeList({
      amount: amount,
...
var withFirstRemoved = function withFirstRemoved(_ref2) {
  ...
  !last.length ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot remove displacement from empty list') : index(false) : void 0;
...
var inHomeList$1 = (function (_ref) {
  ...
  !location ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot move to next index in home list when there is no previous destination') : index(false) : void 0;
  var draggable = draggables[draggableId];
  var axis = droppable.axis;
...
var inForeignList$1 = (function (_ref) {
  var isMovingForward = _ref.isMovingForward,
      ...
      draggables = _ref.draggables,
      viewport = _ref.viewport;
  !previousImpact.destination ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot move to next index where there is no previous destination') : index(false) : void 0;
  var location = previousImpact.destination;
  var draggable = draggables[draggableId];
  var axis = droppable.axis;
...
var reducer = (function (state, action) {
  ...
  if (action.type === 'INITIAL_PUBLISH') {
    !(state.phase === 'PREPARING') ? process.env.NODE_ENV !== "production" ? index(false, 'INITIAL_PUBLISH must come after a PREPARING phase') : index(false) : void 0;
  ...
  if (action.type === 'COLLECTION_STARTING') {
    ...
    !(state.phase === 'DRAGGING') ? process.env.NODE_ENV !== "production" ? index(false, "Collection cannot start from phase " + state.phase) : index(false) : void 0;
  ...
  if (action.type === 'PUBLISH') {
    !(state.phase === 'COLLECTING' || state.phase === 'DROP_PENDING') ? process.env.NODE_ENV !== "production" ? index(false, "Unexpected " + action.type + " received in phase " + state.phase) : index(false) : void 0;
    process.env.NODE_ENV !== "production" ? index(false, "Dynamic additions and removals of Draggable and Droppable components\n      is currently not supported. But will be soon!") : index(false);
  }
  ...
  if (action.type === 'MOVE') {
    ...
    !isMovementAllowed(state) ? process.env.NODE_ENV !== "production" ? index(false, action.type + " not permitted in phase " + state.phase) : index(false) : void 0;
  ...
  if (action.type === 'UPDATE_DROPPABLE_SCROLL') {
    ...
    var _action$payload3 = action.payload,
        ...
        offset$$1 = _action$payload3.offset;
    ...
    var updated = scrollDroppable(target, offset$$1);
    ...
    var _impact = function () {
      !isMovementAllowed(state) ? process.env.NODE_ENV !== "production" ? index(false) : index(false) : void 0;
  ...
  if (action.type === 'UPDATE_DROPPABLE_IS_ENABLED') {
    ...
    !isMovementAllowed(state) ? process.env.NODE_ENV !== "production" ? index(false, "Attempting to move in an unsupported phase " + state.phase) : index(false) : void 0;
    ...
    !(_target.isEnabled !== isEnabled) ? process.env.NODE_ENV !== "production" ? index(false, "Trying to set droppable isEnabled to " + String(isEnabled) + "\n      but it is already " + String(_target.isEnabled)) : index(false) : void 0;
  ...
  if (action.type === 'MOVE_BY_WINDOW_SCROLL') {
    ...
    !isMovementAllowed(state) ? process.env.NODE_ENV !== "production" ? index(false, "Cannot move by window in phase " + state.phase) : index(false) : void 0;
  ...
  if (action.type === 'UPDATE_VIEWPORT_MAX_SCROLL') {
    !state.isDragging ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot update the max viewport scroll if not dragging') : index(false) : void 0;
  ...
  if (action.type === 'MOVE_UP' || action.type === 'MOVE_DOWN' || action.type === 'MOVE_LEFT' || action.type === 'MOVE_RIGHT') {
    ...
    !(state.phase === 'DRAGGING') ? process.env.NODE_ENV !== "production" ? index(false, action.type + " received while not in DRAGGING phase") : index(false) : void 0;
  ...
  if (action.type === 'DROP_PENDING') {
    ...
    !(state.phase === 'COLLECTING') ? process.env.NODE_ENV !== "production" ? index(false, 'Can only move into the DROP_PENDING phase from the COLLECTING phase') : index(false) : void 0;
  ...
  if (action.type === 'DROP_ANIMATE') {
    ...
    !(state.phase === 'DRAGGING' || state.phase === 'DROP_PENDING') ? process.env.NODE_ENV !== "production" ? index(false, "Cannot animate drop from phase " + state.phase) : index(false) : void 0;
    var _result3 = {
  ...
  return function (_ref) {
    ...
    return function (next) {
      return function (action) {
        ...
        !!timeoutId ? process.env.NODE_ENV !== "production" ? index(false, 'There should not be a pending complete lift phase when a lift action is fired') : index(false) : void 0;
        ...
        !(postFlushState.phase === 'IDLE') ? process.env.NODE_ENV !== "production" ? index(false, 'Incorrect phase to start a drag') : index(false) : void 0;
        dispatch(prepare());
        timeoutId = setTimeout(function () {
          timeoutId = null;
          var state = getState();
          !(state.phase === 'PREPARING') ? process.env.NODE_ENV !== "production" ? index(false, 'Invalid phase for completing lift') : index(false) : void 0;
          var scrollOptions = {
...
var drop$1 = (function (_ref) {
  ...
  return function (next) {
    return function (action) {
      ...
      !!isWaitingForDrop ? process.env.NODE_ENV !== "production" ? index(false, 'A DROP action occurred while DROP_PENDING and still waiting') : index(false) : void 0;
      !(state.phase === 'DRAGGING' || state.phase === 'DROP_PENDING') ? process.env.NODE_ENV !== "production" ? index(false, "Cannot drop in phase: " + state.phase) : index(false) : void 0;
...
var finish = function finish(key) {
  if (process.env.NODE_ENV !== 'production') {
    ...
    !previous ? process.env.NODE_ENV !== "production" ? index(false, 'cannot finish timing as no previous time found') : index(false) : void 0;
...
var hooks = (function (getHooks, announce) {
  ...
  var publisher = function () {
    ...
    var start$$1 = function start$$1(critical) {
      !!_isDragStartPublished ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot fire onDragStart as a drag start has already been published') : index(false) : void 0;
    ...
    var move = function move(critical, location) {
      !(_isDragStartPublished && lastCritical) ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot fire onDragMove when onDragStart has not been called') : index(false) : void 0;
    ...
    var drop = function drop(result) {
      !_isDragStartPublished ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot fire onDragEnd when there is no matching onDragStart') : index(false) : void 0;
    ...
    var abort = function abort() {
      !(_isDragStartPublished && lastCritical) ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot cancel when onDragStart not fired') : index(false) : void 0;
...
var dropAnimationFinish = (function (store) {
  return function (next) {
    return function (action) {
      ...
      var state = store.getState();
      !(state.phase === 'DROP_ANIMATING') ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot finish a drop animating when no drop is occurring') : index(false) : void 0;
...
var getNewMaxScroll = function getNewMaxScroll(previous, current, action) {
  ...
  !doc ? process.env.NODE_ENV !== "production" ? index(false, 'Could not find document.documentElement') : index(false) : void 0;
  var maxScroll = getMaxScroll({
...
var createDimensionMarshal = (function (callbacks) {
  ...
  var publisher = createPublisher({
    ...
    getProvided: function getProvided() {
      !collection ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot get scroll options when there is no collection') : index(false) : void 0;
      return {
        entries: entries,
  ...
  var updateDraggable = function updateDraggable(previous, descriptor, getDimension) {
    !entries.draggables[previous.id] ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot update draggable registration as no previous registration was found') : index(false) : void 0;
  ...
  var unregisterDraggable = function unregisterDraggable(descriptor) {
    ...
    !entry ? process.env.NODE_ENV !== "production" ? index(false, "Cannot unregister Draggable with id " + descriptor.id + " as it is not registered") : index(false) : void 0;
    ...
    !(collection.critical.draggable.id !== descriptor.id) ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot remove the dragging item during a drag') : index(false) : void 0;
  ...
  var updateDroppable = function updateDroppable(previous, descriptor, droppableCallbacks) {
    !entries.droppables[previous.id] ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot update droppable registration as no previous registration was found') : index(false) : void 0;
    ...
    if (collection) {
      process.env.NODE_ENV !== "production" ? index(false, 'You are not able to update the id or type of a droppable during a drag') : index(false);
    }
  };

  var unregisterDroppable = function unregisterDroppable(descriptor) {
    var entry = entries.droppables[descriptor.id];
    !entry ? process.env.NODE_ENV !== "production" ? index(false, "Cannot unregister Droppable with id " + descriptor.id + " as as it is not registered") : index(false) : void 0;
    ...
    !(collection.critical.droppable.id !== descriptor.id) ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot remove the home Droppable during a drag') : index(false) : void 0;
  ...
  var updateDroppableIsEnabled = function updateDroppableIsEnabled(id, isEnabled) {
    !entries.droppables[id] ? process.env.NODE_ENV !== "production" ? index(false, "Cannot update the scroll on Droppable " + id + " as it is not registered") : index(false) : void 0;
  ...
  var scrollDroppable = function scrollDroppable(id, change) {
    ...
    !entry ? process.env.NODE_ENV !== "production" ? index(false, "Cannot scroll Droppable " + id + " as it is not registered") : index(false) : void 0;
  ...
  var startPublishing = function startPublishing(request, windowScroll) {
    !!collection ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot start capturing critical dimensions as there is already a collection') : index(false) : void 0;
    var entry = entries.draggables[request.draggableId];
    !entry ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot find critical draggable entry') : index(false) : void 0;
    var home = entries.droppables[entry.descriptor.droppableId];
    !home ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot find critical droppable entry') : index(false) : void 0;
    var critical = {
...
var getHead = function getHead() {
  ...
  !head ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot find the head to append a style to') : index(false) : void 0;
  return head;
};
...
var createStyleMarshal = (function () {
  ...
  var setStyle = index$1(function (proposed) {
    !el ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot set style of style tag if not mounted') : index(false) : void 0;
    el.innerHTML = proposed;
  });

  var mount = function mount() {
    !!el ? process.env.NODE_ENV !== "production" ? index(false, 'Style marshal already mounted') : index(false) : void 0;
  ...
  var unmount = function unmount() {
    !el ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot unmount style marshal as it is already unmounted') : index(false) : void 0;
...
var getBody = function getBody() {
  !document.body ? process.env.NODE_ENV !== "production" ? index(false, 'Announcer cannot find document.body') : index(false) : void 0;
...
var createAnnouncer = (function () {
  ...
  var announce = function announce(message) {
    !el ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot announce to unmounted node') : index(false) : void 0;
    el.textContent = message;
  };

  var mount = function mount() {
    !!el ? process.env.NODE_ENV !== "production" ? index(false, 'Announcer already mounted') : index(false) : void 0;
  ...
  var unmount = function unmount() {
    !el ? process.env.NODE_ENV !== "production" ? index(false, 'Will not unmount annoucer as it is already unmounted') : index(false) : void 0;
...
var getScrollableDroppableOver = function getScrollableDroppableOver(target, droppables) {
  var maybe = getScrollableDroppables(droppables).find(function (droppable) {
    !droppable.viewport.closestScrollable ? process.env.NODE_ENV !== "production" ? index(false, 'Invalid result') : index(false) : void 0;
...
var createJumpScroller = (function (_ref) {
  ...
  var jumpScroller = function jumpScroller(state) {
    ...
    !destination ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot perform a jump scroll when there is no destination') : index(false) : void 0;
...
var DroppableDimensionPublisher = function (_React$Component) {
  ...
  function DroppableDimensionPublisher(props, context) {
    ...
    _this.memoizedUpdateScroll = index$1(function (x, y) {
      !_this.publishedDescriptor ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot update scroll on unpublished droppable') : index(false) : void 0;
      var newScroll = {
        x: x,
        y: y
      };
    ...
    _this.onClosestScroll = function () {
      !_this.watchingScroll ? process.env.NODE_ENV !== "production" ? index(false, 'Could not find scroll options while scrolling') : index(false) : void 0;
    ...
    _this.scroll = function (change) {
      !_this.watchingScroll ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot scroll a droppable with no closest scrollable') : index(false) : void 0;
    ...
    _this.watchScroll = function (closestScrollable, options) {
      !!_this.watchingScroll ? process.env.NODE_ENV !== "production" ? index(false, 'Droppable cannot watch scroll as it is already watching scroll') : index(false) : void 0;
    ...
    _this.unpublish = function () {
      !_this.publishedDescriptor ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot unpublish descriptor when none is published') : index(false) : void 0;
      var marshal = _this.context[dimensionMarshalKey];
    ...
    _this.getDimensionAndWatchScroll = function (windowScroll, options) {
      ...
      !targetRef ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot calculate a dimension when not attached to the DOM') : index(false) : void 0;
      !descriptor ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot get dimension for unpublished droppable') : index(false) : void 0;
...
var throwIfRefIsInvalid = (function (ref) {
  !(ref && ref instanceof HTMLElement) ? process.env.NODE_ENV !== "production" ? index(false, "\n    provided.innerRef has not been provided with a HTMLElement.\n\n    You can find a guide on using the innerRef callback functions at:\n    https://github.com/atlassian/react-beautiful-dnd/blob/master/docs/guides/using-inner-ref.md\n  ") : index(false) : void 0;
});
...
var DraggableDimensionPublisher = function (_Component) {
  ...
  function DraggableDimensionPublisher() {
    ...
    _this.getDimension = function (windowScroll) {
      ...
      var descriptor = _this.publishedDescriptor;
      !targetRef ? process.env.NODE_ENV !== "production" ? index(false, 'DraggableDimensionPublisher cannot calculate a dimension when not attached to the DOM') : index(false) : void 0;
      !descriptor ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot get dimension for unpublished draggable') : index(false) : void 0;
...
var throwIfSVG = function throwIfSVG(el) {
  !!isSVG(el) ? process.env.NODE_ENV !== "production" ? index(false, "A drag handle cannot be an SVGElement: it has inconsistent focus support.\n\n    More information: https://github.com/atlassian/react-beautiful-dnd/tree/master/docs/guides/dragging-svgs.md") : index(false) : void 0;
};
...
var getDragHandleRef = function getDragHandleRef(draggableRef) {
  ...
  throwIfSVG(draggableRef);
  !el ? process.env.NODE_ENV !== "production" ? index(false, "\n      Cannot find drag handle element inside of Draggable.\n      Please be sure to apply the {...provided.dragHandleProps} to your Draggable\n\n      More information: https://github.com/atlassian/react-beautiful-dnd#draggable\n    ") : index(false) : void 0;
  !(el instanceof HTMLElement) ? process.env.NODE_ENV !== "production" ? index(false, 'A drag handle must be a HTMLElement') : index(false) : void 0;
  return el;
};
...
var createEventMarshal = (function () {
  ...
  var handle = function handle() {
    !!isMouseDownHandled ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot handle mouse down as it is already handled') : index(false) : void 0;
...
var createMouseSensor = (function (_ref) {
  ...
  var windowBindings = [{
    ...
    fn: function fn(event) {
      ...
      if (!state.pending) {
        kill();
        process.env.NODE_ENV !== "production" ? index(false, 'Expected there to be a pending drag') : index(false);
      }
  ...
  var onMouseDown = function onMouseDown(event) {
    ...
    !!isCapturing() ? process.env.NODE_ENV !== "production" ? index(false, 'Should not be able to perform a mouse down while a drag or pending drag is occurring') : index(false) : void 0;
...
var createKeyboardSensor = (function (_ref) {
  ...
  var onKeyDown = function onKeyDown(event) {
    if (!isDragging()) {
      ...
      !ref ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot start a keyboard drag without a draggable ref') : index(false) : void 0;
...
var createTouchSensor = (function (_ref) {
  ...
  var startDragging = function startDragging() {
    ...
    if (!pending) {
      kill();
      process.env.NODE_ENV !== "production" ? index(false, 'cannot start a touch drag without a pending position') : index(false);
    }
  ...
  var onTouchStart = function onTouchStart(event) {
    ...
    !!isCapturing() ? process.env.NODE_ENV !== "production" ? index(false, 'Should not be able to perform a touch start while a drag or pending drag is occurring') : index(false) : void 0;
...
var DragHandle = function (_Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    !draggableRef ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot get draggable ref from drag handle') : index(false) : void 0;
...
var getTranslate = function getTranslate(offset$$1) {
  if (isEqual(offset$$1, origin)) {
    return null;
  }

  return "translate(" + offset$$1.x + "px, " + offset$$1.y + "px)";
};
...
var Draggable = function (_Component) {
  ...
  function Draggable(props, context) {
    ...
    _this.onLift = function (options) {
      start('LIFT');
      var ref = _this.ref;
      !ref ? process.env.NODE_ENV !== "production" ? index(false) : index(false) : void 0;
      !!_this.props.isDragDisabled ? process.env.NODE_ENV !== "production" ? index(false, 'Cannot lift a Draggable when it is disabled') : index(false) : void 0;
    ...
    _this.getProvided = index$1(function (change, isDragging, isDropAnimating, shouldAnimateDisplacement, dimension, dragHandleProps) {
      ...
      var draggableStyle = function () {
        ...
        !dimension ? process.env.NODE_ENV !== "production" ? index(false, 'draggable dimension required for dragging') : index(false) : void 0;
    ...
    _this.renderChildren = function (change, dragHandleProps) {
      ...
      var placeholder = function () {
        ...
        !dimension ? process.env.NODE_ENV !== "production" ? index(false, 'Draggable: Dimension is required for dragging') : index(false) : void 0;
        return React__default.createElement(Placeholder, {
          placeholder: dimension.placeholder
        });
      }();

      return React__default.createElement(Fragment, null, child, placeholder);
    };
...
var makeMapStateToProps$1 = function makeMapStateToProps() {
  ...
  var getNotDraggingProps = index$1(function (offset$$1, shouldAnimateDisplacement) {
    return {
      isDropAnimating: false,
      isDragging: false,
      offset: offset$$1,
  ...
  var getDraggingProps = index$1(function (offset$$1, shouldAnimateDragMovement, dimension, draggingOver) {
    return {
      isDragging: true,
      isDropAnimating: false,
  ...
  var draggingSelector = function draggingSelector(state, ownProps) {
    if (state.isDragging) {
      ...
      return getDraggingProps(memoizedOffset(offset$$1.x, offset$$1.y), shouldAnimateDragMovement, dimension, draggingOver);
    }
...
}, grid, grid, borderRadius, colors.shadow, function (props) {
    return props.isDragging ? 'box-shadow: 2px 2px 1px ' + colors.shadow + ';' : '';
}, function (props) {
    return props.isGhosting ? 'opacity: 0.8;' : '';
}, colors.blue.deep);
/* stylelint-disable block-no-empty */
var Content = styled.div(_templateObject2);

var size = 30;
var SelectionCount = styled.div(_templateObject3, grid, grid, colors.white, colors.blue.deep, size, size, size);

var DraggableItem = function (_Component) {
    inherits$1(DraggableItem, _Component);
    ...
    function DraggableItem() {
        ...
        classCallCheck$1(this, DraggableItem);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref3 = DraggableItem.__proto__ || Object.getPrototypeOf(DraggableItem)).call.apply(_ref3, [this].concat(args))), _this), _this.onKeyDown = function (event, provided, snapshot) {
            ...
            var wasMetaKeyUsed = event.metaKey || event.ctrlKey;
            var wasShiftKeyUsed = event.shiftKey;

            _this.performAction(wasMetaKeyUsed, wasShiftKeyUsed);
            ...
            event.preventDefault();
            _this.props.toggleSelectionInGroup(_this.props.item.id);
        }, _this.performAction = function (wasMetaKeyUsed, wasShiftKeyUsed) {
            var _this$props = _this.props,
                item = _this$props.item,
                toggleSelection = _this$props.toggleSelection,
                toggleSelectionInGroup = _this$props.toggleSelectionInGroup,
                multiSelectTo = _this$props.multiSelectTo;
    ...
    createClass$1(DraggableItem, [{
        ...
        value: function render() {
            ...
            var selectionCount = this.props.selectionCount;
            var isSelected = this.props.isSelected;
            var isGhosting = this.props.isGhosting;
            return React__default.createElement(
                ConnectedDraggable,
                    ...
                    return React__default.createElement(
                        ...
                        _extends$6({
                            ...
                            onKeyDown: function onKeyDown(event) {
                                return _this2.onKeyDown(event, provided, snapshot);
                            },
                        ...
                        shouldShowSelection ? React__default.createElement(
                            SelectionCount,
                            null,
                            selectionCount
                        ) : null
...
var Container$1 = styled.div(_templateObject$1, grid, borderRadius, colors.grey.dark, colors.grey.medium);

var Title = styled.h3(_templateObject2$1);

var ItemList = styled.div(_templateObject3$1, function (props) {
  return props.isDraggingOver ? 'background-color: ' + colors.grey.darker : '';
});

var getSelectedMap = index$1(function (selectedItemIds) {
  return selectedItemIds.reduce(function (previous, current) {
...
var Column = function (_Component) {
  inherits$1(Column, _Component);

  function Column() {
    classCallCheck$1(this, Column);
    return possibleConstructorReturn$1(this, (Column.__proto__ || Object.getPrototypeOf(Column)).apply(this, arguments));
  }

  createClass$1(Column, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
      ...
      var selectedItemIds = this.props.selectedItemIds;
      var draggingItemId = this.props.draggingItemId;
      return React__default.createElement(
        Container$1,
        null,
        React__default.createElement(
          ...
          function (provided, snapshot) {
            return React__default.createElement(
              ...
              items.map(function (item, index) {
                var isSelected = getSelectedMap(selectedItemIds)[item.id];
                var isGhosting = isSelected && Boolean(draggingItemId) && draggingItemId !== item.id;
                return React__default.createElement(DraggableItem, {
                  item: item,
                  index: index,
                  key: item.id,
                  isSelected: isSelected,
                  ...
                  toggleSelection: _this2.props.toggleSelection,
                  toggleSelectionInGroup: _this2.props.toggleSelectionInGroup,
                  multiSelectTo: _this2.props.multiSelectTo
                });
              }),
...
var withNewItemIds = function withNewItemIds(column, selectedItemIds) {
    return {
        id: column.id,
        title: column.title,
...
var reorderSingleDrag = function reorderSingleDrag(_ref) {
    ...
    var columns = _ref.columns,
        selectedItemIds = _ref.selectedItemIds,
        source = _ref.source,
        destination = _ref.destination;
    ...
    if (source.droppableId === destination.droppableId) {
        ...
        var reordered = reorder(column.selectedItemIds, source.index, destination.index);

        var _updatedColumns = _extends$6({}, columns, defineProperty$1({}, column.id, withNewItemIds(column, reordered)));

        return {
            columns: _updatedColumns,
            selectedItemIds: selectedItemIds
        };
    }

    // moving to a new list
    var home = columns[source.droppableId];
    var foreign = columns[destination.droppableId];

    // the id of the item to be moved
    var itemId = home.selectedItemIds[source.index];

    // remove from home column
    var newHomeItemIds = [].concat(toConsumableArray(home.selectedItemIds));
    newHomeItemIds.splice(source.index, 1);

    // add to foreign column
    var newForeignItemIds = [].concat(toConsumableArray(foreign.selectedItemIds));
    newForeignItemIds.splice(destination.index, 0, itemId);

    var updatedColumns = _extends$6({}, columns, (_babelHelpers$extends2 = {}, defineProperty$1(_babelHelpers$extends2, home.id, withNewItemIds(home, newHomeItemIds)), defineProperty$1(_babelHelpers$extends2, foreign.id, withNewItemIds(foreign, newForeignItemIds)), _babelHelpers$extends2));
...
var getHomeColumn = function getHomeColumn(columns, itemId) {
    var columnId = Object.keys(columns).find(function (id) {
...
var reorderMultiDrag = function reorderMultiDrag(_ref2) {
    var columns = _ref2.columns,
        selectedItemIds = _ref2.selectedItemIds,
        source = _ref2.source,
        destination = _ref2.destination;

    var start = columns[source.droppableId];
    var dragged = start.selectedItemIds[source.index];

    var insertAtIndex = function () {
        var destinationIndexOffset = selectedItemIds.reduce(function (previous, current) {
            if (current === dragged) {
                return previous;
            }

            var final = columns[destination.droppableId];
            var column = getHomeColumn(columns, current);

            if (column !== final) {
                return previous;
            }

            var index = column.selectedItemIds.indexOf(current);
    ...
    var orderedSelectedItemIds = [].concat(toConsumableArray(selectedItemIds));
    orderedSelectedItemIds.sort(function (a, b) {
        ...
        var columnForA = getHomeColumn(columns, a);
        var indexOfA = columnForA.selectedItemIds.indexOf(a);
        var columnForB = getHomeColumn(columns, b);
        var indexOfB = columnForB.selectedItemIds.indexOf(b);
    ...
    var withRemovedItems = Object.keys(columns).reduce(function (previous, columnId) {
        var column = columns[columnId];

        // remove the id's of the items that are selected
        var remainingItemIds = column.selectedItemIds.filter(function (id) {
    ...
    var withInserted = function () {
        var base = [].concat(toConsumableArray(final.selectedItemIds));
        base.splice.apply(base, [insertAtIndex, 0].concat(toConsumableArray(orderedSelectedItemIds)));
        return base;
    }();

    // insert all selected tasks into final column
    var withAddedTasks = _extends$6({}, withRemovedItems, defineProperty$1({}, final.id, withNewItemIds(final, withInserted)));
...
var mutliDragAwareReorder = function mutliDragAwareReorder(args) {
...
var multiSelectTo = function multiSelectTo(columns, selectedItemIds, newItemId) {
    // Nothing already selected
    if (!selectedItemIds.length) {
        return [newItemId];
    }

    var columnOfNew = getHomeColumn(columns, newItemId);
    var indexOfNew = columnOfNew.selectedItemIds.indexOf(newItemId);

    var lastSelected = selectedItemIds[selectedItemIds.length - 1];
    var columnOfLast = getHomeColumn(columns, lastSelected);
    var indexOfLast = columnOfLast.selectedItemIds.indexOf(lastSelected);
    ...
    var inBetween = columnOfNew.selectedItemIds.slice(start, end + 1);
    ...
    var sorted = isSelectingForwards ? toAdd : [].concat(toConsumableArray(toAdd)).reverse();
    var combined = [].concat(toConsumableArray(selectedItemIds), toConsumableArray(sorted));

    return combined;
};

var prefix$2 = '@@redux-form/';

var ARRAY_INSERT = prefix$2 + 'ARRAY_INSERT';
var ARRAY_MOVE = prefix$2 + 'ARRAY_MOVE';
var ARRAY_POP = prefix$2 + 'ARRAY_POP';
var ARRAY_PUSH = prefix$2 + 'ARRAY_PUSH';
var ARRAY_REMOVE = prefix$2 + 'ARRAY_REMOVE';
var ARRAY_REMOVE_ALL = prefix$2 + 'ARRAY_REMOVE_ALL';
var ARRAY_SHIFT = prefix$2 + 'ARRAY_SHIFT';
var ARRAY_SPLICE = prefix$2 + 'ARRAY_SPLICE';
var ARRAY_UNSHIFT = prefix$2 + 'ARRAY_UNSHIFT';
var ARRAY_SWAP = prefix$2 + 'ARRAY_SWAP';
var AUTOFILL = prefix$2 + 'AUTOFILL';
var BLUR = prefix$2 + 'BLUR';
var CHANGE = prefix$2 + 'CHANGE';
var CLEAR_FIELDS = prefix$2 + 'CLEAR_FIELDS';
var CLEAR_SUBMIT = prefix$2 + 'CLEAR_SUBMIT';
var CLEAR_SUBMIT_ERRORS = prefix$2 + 'CLEAR_SUBMIT_ERRORS';
var CLEAR_ASYNC_ERROR = prefix$2 + 'CLEAR_ASYNC_ERROR';
var DESTROY = prefix$2 + 'DESTROY';
var FOCUS = prefix$2 + 'FOCUS';
var INITIALIZE = prefix$2 + 'INITIALIZE';
var REGISTER_FIELD = prefix$2 + 'REGISTER_FIELD';
var RESET = prefix$2 + 'RESET';
var RESET_SECTION = prefix$2 + 'RESET_SECTION';
var SET_SUBMIT_FAILED = prefix$2 + 'SET_SUBMIT_FAILED';
var SET_SUBMIT_SUCCEEDED = prefix$2 + 'SET_SUBMIT_SUCCEEDED';
var START_ASYNC_VALIDATION = prefix$2 + 'START_ASYNC_VALIDATION';
var START_SUBMIT = prefix$2 + 'START_SUBMIT';
var STOP_ASYNC_VALIDATION = prefix$2 + 'STOP_ASYNC_VALIDATION';
var STOP_SUBMIT = prefix$2 + 'STOP_SUBMIT';
var SUBMIT = prefix$2 + 'SUBMIT';
var TOUCH = prefix$2 + 'TOUCH';
var UNREGISTER_FIELD = prefix$2 + 'UNREGISTER_FIELD';
var UNTOUCH = prefix$2 + 'UNTOUCH';
var UPDATE_SYNC_ERRORS = prefix$2 + 'UPDATE_SYNC_ERRORS';
var UPDATE_SYNC_WARNINGS = prefix$2 + 'UPDATE_SYNC_WARNINGS';
...
var initialize = function initialize(form, values, keepDirty) {
  ...
  return {
    type: INITIALIZE,
    meta: _extends$7({ form: form, keepDirty: keepDirty }, otherMeta),
    payload: values
  };
};
...
var Form = function (_Component) {
  ...
  function Form(props, context) {
    _classCallCheck$3(this, Form);

    var _this = _possibleConstructorReturn$2(this, (Form.__proto__ || Object.getPrototypeOf(Form)).call(this, props, context));
...
var FormSection = function (_Component) {
  _inherits$3(FormSection, _Component);

  function FormSection(props, context) {
    _classCallCheck$4(this, FormSection);

    var _this = _possibleConstructorReturn$3(this, (FormSection.__proto__ || Object.getPrototypeOf(FormSection)).call(this, props, context));
  ...
  _createClass$1(FormSection, [{
    ...
    value: function getChildContext() {
      ...
      return {
        _reduxForm: _extends$8({}, context._reduxForm, {
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties$3(_props, ['children', 'name', 'component']);

      if (React__default.isValidElement(children)) {
        return children;
      }

      return createElement(component, _extends$8({}, rest, {
        children: children
      }));
    }
  }]);
...
var ExtendableError = function (_extendableBuiltin2) {
  _inherits$4(ExtendableError, _extendableBuiltin2);

  function ExtendableError() {
    var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

    _classCallCheck$5(this, ExtendableError);

    // extending Error is weird and does not propagate `message`
    var _this = _possibleConstructorReturn$4(this, (ExtendableError.__proto__ || Object.getPrototypeOf(ExtendableError)).call(this, message));
...
var SubmissionError = function (_ExtendableError) {
  _inherits$5(SubmissionError, _ExtendableError);

  function SubmissionError(errors) {
    _classCallCheck$6(this, SubmissionError);

    var _this = _possibleConstructorReturn$5(this, (SubmissionError.__proto__ || Object.getPrototypeOf(SubmissionError)).call(this, 'Submit Validation Failed'));
...
var createFieldProps = function createFieldProps(_ref2, name, _ref) {
  ...
  var asyncError = _ref.asyncError,
      ...
      _value = _ref._value,
      warn = _ref.warn,
      custom = _objectWithoutProperties$4(_ref, ['asyncError', 'asyncValidating', 'onBlur', 'onChange', 'onDrop', 'onDragStart', 'dirty', 'dispatch', 'onFocus', 'form', 'format', 'initial', 'parse', 'pristine', 'props', 'state', 'submitError', 'submitFailed', 'submitting', 'syncError', 'syncWarning', 'validate', 'value', '_value', 'warn']);
  ...
  return {
    ...
    custom: _extends$9({}, custom, props)
  };
};
...
var setInWithPath = function setInWithPath(state, value, path, pathIndex) {
  ...
  return _extends$a({}, state, _defineProperty({}, first, next));
};
...
function deleteInWithPath(state, first) {
  ...
  if (rest.length) {
    ...
    if (first in state) {
      ...
      return state[first] === _result ? state : _extends$b({}, state, _defineProperty$1({}, first, _result));
    }
    return state;
  }
  if (Array.isArray(state)) {
...
var isObject$1 = function isObject(entity) {
  return entity && (typeof entity === 'undefined' ? 'undefined' : _typeof$3(entity)) === 'object';
};

var isFunction$2 = function isFunction(entity) {
  return entity && typeof entity === 'function';
};

var eventPreventDefault = function eventPreventDefault(event) {
  if (isObject$1(event) && isFunction$2(event.preventDefault)) {
    event.preventDefault();
  }
};

var eventDataTransferGetData = function eventDataTransferGetData(event, key) {
  if (isObject$1(event) && isObject$1(event.dataTransfer) && isFunction$2(event.dataTransfer.getData)) {
    return event.dataTransfer.getData(key);
  }
};

var eventDataTransferSetData = function eventDataTransferSetData(event, key, value) {
  if (isObject$1(event) && isObject$1(event.dataTransfer) && isFunction$2(event.dataTransfer.setData)) {
...
var createConnectedField = function createConnectedField(structure$$1) {
  ...
  var ConnectedField = function (_Component) {
    _inherits$6(ConnectedField, _Component);
    ...
    function ConnectedField() {
      ...
      _classCallCheck$7(this, ConnectedField);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, (_ref = ConnectedField.__proto__ || Object.getPrototypeOf(ConnectedField)).call.apply(_ref, [this].concat(args))), _this), _this.saveRef = function (ref) {
    ...
    _createClass$2(ConnectedField, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties$5(_props, ['component', 'withRef', 'name', '_reduxForm', 'normalize', 'onBlur', 'onChange', 'onFocus', 'onDragStart', 'onDrop', 'immutableProps']);

        var _createFieldProps = createFieldProps(structure$$1, name, _extends$c({}, rest, {
          ...
          onFocus: this.handleFocus
            ...
            props = _objectWithoutProperties$5(_createFieldProps, ['custom']);
 ...
 // eslint-disable-line no-unused-vars
          ...
          return createElement(component, _extends$c({}, input, custom));
        } else {
          return createElement(component, _extends$c({}, props, custom));
        }
      }
    }]);
...
var createField = function createField(structure$$1) {
  ...
  var Field = function (_Component) {
    _inherits$7(Field, _Component);

    function Field(props, context) {
      _classCallCheck$8(this, Field);

      var _this = _possibleConstructorReturn$7(this, (Field.__proto__ || Object.getPrototypeOf(Field)).call(this, props, context));
    ...
    _createClass$3(Field, [{
      ...
      key: 'render',
      value: function render() {
        return createElement(ConnectedField, _extends$d({}, this.props, {
          name: this.name,
...
var createConnectedFields = function createConnectedFields(structure$$1) {
  ...
  var ConnectedFields = function (_React$Component) {
    _inherits$8(ConnectedFields, _React$Component);

    function ConnectedFields(props) {
      _classCallCheck$9(this, ConnectedFields);

      var _this = _possibleConstructorReturn$8(this, (ConnectedFields.__proto__ || Object.getPrototypeOf(ConnectedFields)).call(this, props));
    ...
    _createClass$4(ConnectedFields, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            _reduxForm = _props._reduxForm,
            rest = _objectWithoutProperties$6(_props, ['component', 'withRef', '_fields', '_reduxForm']);
        ...
        var _Object$keys$reduce = Object.keys(_fields).reduce(function (accumulator, name) {
          ...
          var _createFieldProps = createFieldProps(structure$$1, name, _extends$e({}, connectedProps, rest, {
            form: form,
            ...
            onFocus: _this4.onFocusFns[name]
              ...
              custom = _createFieldProps.custom,
              fieldProps = _objectWithoutProperties$6(_createFieldProps, ['custom']);
          ...
          return structure.setIn(accumulator, fieldName, fieldProps);
            ...
            props = _objectWithoutProperties$6(_Object$keys$reduce, ['custom']);

        if (withRef) {
          props.ref = this.saveRef;
        }

        return createElement(component, _extends$e({}, props, custom));
      }
    }]);
...
var createFields = function createFields(structure$$1) {
  ...
  var Fields = function (_Component) {
    _inherits$9(Fields, _Component);

    function Fields(props, context) {
      _classCallCheck$a(this, Fields);

      var _this = _possibleConstructorReturn$9(this, (Fields.__proto__ || Object.getPrototypeOf(Fields)).call(this, props, context));
    ...
    _createClass$5(Fields, [{
      ...
      value: function render() {
        ...
        return createElement(ConnectedFields, _extends$f({}, this.props, {
...
var createFieldArrayProps = function createFieldArrayProps(_ref2, name, form, sectionPrefix, getValue, _ref) {
  ...
  var arrayInsert = _ref.arrayInsert,
      ...
      value = _ref.value,
      props = _ref.props,
      rest = _objectWithoutProperties$7(_ref, ['arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncError', 'dirty', 'length', 'pristine', 'submitError', 'state', 'submitFailed', 'submitting', 'syncError', 'syncWarning', 'value', 'props']);

  var error = syncError || asyncError || submitError;
  var warning = syncWarning;
  var fieldName = sectionPrefix ? name.replace(sectionPrefix + '.', '') : name;
  var finalProps = _extends$g({
    fields: {
      _isFieldArray: true,
...
var createConnectedFieldArray = function createConnectedFieldArray(structure$$1) {
  ...
  var ConnectedFieldArray = function (_React$Component) {
    _inherits$a(ConnectedFieldArray, _React$Component);
    ...
    function ConnectedFieldArray() {
      ...
      _classCallCheck$b(this, ConnectedFieldArray);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _ret = (_temp = (_this = _possibleConstructorReturn$a(this, (_ref = ConnectedFieldArray.__proto__ || Object.getPrototypeOf(ConnectedFieldArray)).call.apply(_ref, [this].concat(args))), _this), _this.saveRef = function (ref) {
        _this.ref = ref;
    ...
    _createClass$6(ConnectedFieldArray, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties$8(_props, ['component', 'withRef', 'name', '_reduxForm', 'validate', 'warn', 'rerenderOnEveryChange']);
...
var createFieldArray = function createFieldArray(structure) {
  ...
  var FieldArray = function (_Component) {
    _inherits$b(FieldArray, _Component);

    function FieldArray(props, context) {
      _classCallCheck$c(this, FieldArray);

      var _this = _possibleConstructorReturn$b(this, (FieldArray.__proto__ || Object.getPrototypeOf(FieldArray)).call(this, props, context));
    ...
    _createClass$7(FieldArray, [{
      ...
      key: 'render',
      value: function render() {
        return createElement(ConnectedFieldArray, _extends$h({}, this.props, {
          name: this.name,
          _reduxForm: this.context._reduxForm,
          ref: this.saveRef
        }));
...
createFormValueSelector(structure);
  ...
  return function (firstArg) {
    ...
    return function (Component$$1) {
      var FormValues = function (_React$Component) {
        _inherits$c(FormValues, _React$Component);

        function FormValues(props, context) {
          _classCallCheck$d(this, FormValues);

          var _this = _possibleConstructorReturn$c(this, (FormValues.__proto__ || Object.getPrototypeOf(FormValues)).call(this, props, context));
        ...
        _createClass$8(FormValues, [{
          ...
          value: function render() {
            ...
            , _extends$i({ sectionPrefix: this.context._reduxForm.sectionPrefix
            }, this.props));
          }
        }, {
          key: 'updateComponent',
          value: function updateComponent(props) {
            ...
            if (typeof resolvedFirstArg === 'string') {
              valuesMap = rest.reduce(function (result, k) {
                result[k] = k;
                return result;
              }, _defineProperty$3({}, resolvedFirstArg, resolvedFirstArg));
            } else {
            ...
            if (isEqual$1(valuesMap, this._valuesMap)) {
...
createGetFormInitialValues(structure);
...
createGetFormSyncErrors(structure);
...
createGetFormAsyncErrors(structure);
...
createGetFormSyncWarnings(structure);
...
createGetFormSubmitErrors(structure);
...
createIsAsyncValidating(structure);
...
createIsPristine(structure);

createIsValid(structure);
...
createHasSubmitSucceeded(structure);
...
createHasSubmitFailed(structure);
...
var handleSubmit = function handleSubmit(submit, props, valid, asyncValidate, fields) {
  ...
  if (valid || persistentSubmitErrors) {
    ...
    setSubmitFailed.apply(undefined, _toConsumableArray$3(fields));
    var errors = _extends$j({}, asyncErrors, syncErrors);
    if (onSubmitFail) {
...
var arrayInsert$1 = actions.arrayInsert,
    arrayMove$1 = actions.arrayMove,
    arrayPop$1 = actions.arrayPop,
    arrayPush$2 = actions.arrayPush,
    arrayRemove$1 = actions.arrayRemove,
    arrayRemoveAll$1 = actions.arrayRemoveAll,
    arrayShift$1 = actions.arrayShift,
    arraySplice$1 = actions.arraySplice,
    arraySwap$1 = actions.arraySwap,
    arrayUnshift$1 = actions.arrayUnshift,
    blur$1 = actions.blur,
    change$1 = actions.change,
    focus$1 = actions.focus,
    formActions = _objectWithoutProperties$a(actions, ['arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'blur', 'change', 'focus']);

var arrayActions = {
  arrayInsert: arrayInsert$1,
  arrayMove: arrayMove$1,
  arrayPop: arrayPop$1,
  arrayPush: arrayPush$2,
...
var propsToNotUpdateFor$3 = [].concat(_toConsumableArray$4(Object.keys(actions)), ['array', 'asyncErrors', 'initialValues', 'syncErrors', 'syncWarnings', 'values', 'registeredFields']);
      ...
      var Form = function (_Component) {
            ...
            if (!submitOrEvent || silenceEvent(submitOrEvent)) {
              ...
              if (!_this.submitPromise) {
                ...
                if (_this.innerOnSubmit && _this.innerOnSubmit !== _this.submit) {
                  ...
                  return _this.listenToSubmit(handleSubmit(checkSubmit(onSubmit), _extends$k({}, _this.props, bindActionCreators({ blur: blur, change: change }, dispatch)), _this.props.validExceptSubmit, _this.asyncValidate, _this.getFieldList({ excludeFieldArray: true })));
                }
              }
            } else {
              // submitOrEvent is the submit function: return deferred submit thunk
              return silenceEvents(function () {
                return !_this.submitPromise && _this.listenToSubmit(handleSubmit(checkSubmit(submitOrEvent), _extends$k({}, _this.props, bindActionCreators({ blur: blur, change: change }, dispatch)), _this.props.validExceptSubmit, _this.asyncValidate, _this.getFieldList({ excludeFieldArray: true })));
              });
            }
        ...
        _createClass$9(Form, [{
          ...
          value: function getChildContext() {
            ...
            return {
              _reduxForm: _extends$k({}, this.props, {
                getFormState: function getFormState(state) {
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge2 = merge(validate ? validate(propsToValidate.values, propsToValidate) || {} : {}, fieldLevelValidate ? fieldLevelValidate(propsToValidate.values, propsToValidate) || {} : {}),
                    ...
                    nextSyncErrors = _objectWithoutProperties$a(_merge2, ['_error']);
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge3 = merge(warn ? warn(propsToWarn.values, propsToWarn) : {}, fieldLevelWarn ? fieldLevelWarn(propsToWarn.values, propsToWarn) : {}),
                    ...
                    nextSyncWarnings = _objectWithoutProperties$a(_merge3, ['_warning']);
          ...
          value: function render() {
            ...
            var _props9 = this.props,
                ...
                rest = _objectWithoutProperties$a(_props9, ['anyTouched', 'array', 'arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncErrors', 'asyncValidate', 'asyncValidating', 'blur', 'change', 'clearSubmit', 'destroy', 'destroyOnUnmount', 'forceUnregisterOnUnmount', 'dirty', 'dispatch', 'enableReinitialize', 'error', 'focus', 'form', 'getFormState', 'immutableProps', 'initialize', 'initialized', 'initialValues', 'invalid', 'keepDirtyOnReinitialize', 'keepValues', 'updateUnregisteredFields', 'pristine', 'propNamespace', 'registeredFields', 'registerField', 'reset', 'resetSection', 'setSubmitFailed', 'setSubmitSucceeded', 'shouldAsyncValidate', 'shouldValidate', 'shouldError', 'shouldWarn', 'startAsyncValidation', 'startSubmit', 'stopAsyncValidation', 'stopSubmit', 'submitting', 'submitFailed', 'submitSucceeded', 'touch', 'touchOnBlur', 'touchOnChange', 'persistentSubmitErrors', 'syncErrors', 'syncWarnings', 'unregisterField', 'untouch', 'updateSyncErrors', 'updateSyncWarnings', 'valid', 'validExceptSubmit', 'values', 'warning']);
            ...
            var propsToPass = _extends$k({}, propNamespace ? _defineProperty$4({}, propNamespace, reduxFormProps) : reduxFormProps, rest);
...
propsToPass.ref = this.saveRef;
      ...
      var connector = connect(function (state, props) {
        ...
        var syncErrors = getIn(formState, 'syncErrors') || structure.empty;
        var syncWarnings = getIn(formState, 'syncWarnings') || structure.empty;
        ...
        var computedActions = _extends$k({}, connectedFormACs, boundArrayACs, {
          blur: boundBlur,
          change: boundChange,
      ...
      var ReduxForm = function (_Component2) {
        _inherits$d(ReduxForm, _Component2);

        function ReduxForm() {
          _classCallCheck$e(this, ReduxForm);

          return _possibleConstructorReturn$d(this, (ReduxForm.__proto__ || Object.getPrototypeOf(ReduxForm)).apply(this, arguments));
        }
        ...
        _createClass$9(ReduxForm, [{
          ...
          value: function render() {
            ...
            var _props10 = this.props,
                ...
                rest = _objectWithoutProperties$a(_props10, ['initialValues']);

            return createElement(ConnectedForm, _extends$k({}, rest, {
...
var isReduxFormAction = function isReduxFormAction(action) {
  return action && action.type && action.type.length > prefix$2.length && action.type.substring(0, prefix$2.length) === prefix$2;
};
...
function createReducer(structure$$1) {
  ...
  var behaviors = (_behaviors = {}, _defineProperty$5(_behaviors, ARRAY_INSERT, function (state, _ref2) {
  ...
  }), _defineProperty$5(_behaviors, ARRAY_MOVE, function (state, _ref3) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, ARRAY_POP, function (state, _ref4) {
    var field = _ref4.meta.field;

    var array = getIn(state, 'values.' + field);
    var length = array ? size(array) : 0;
    return length ? arraySplice(state, field, length - 1, 1) : state;
  }), _defineProperty$5(_behaviors, ARRAY_PUSH, function (state, _ref5) {
  ...
  }), _defineProperty$5(_behaviors, ARRAY_REMOVE, function (state, _ref6) {
    var _ref6$meta = _ref6.meta,
        field = _ref6$meta.field,
        index = _ref6$meta.index;

    return arraySplice(state, field, index, 1);
  }), _defineProperty$5(_behaviors, ARRAY_REMOVE_ALL, function (state, _ref7) {
    var field = _ref7.meta.field;

    var array = getIn(state, 'values.' + field);
    var length = array ? size(array) : 0;
    return length ? arraySplice(state, field, 0, length) : state;
  }), _defineProperty$5(_behaviors, ARRAY_SHIFT, function (state, _ref8) {
    var field = _ref8.meta.field;

    return arraySplice(state, field, 0, 1);
  }), _defineProperty$5(_behaviors, ARRAY_SPLICE, function (state, _ref9) {
  ...
  }), _defineProperty$5(_behaviors, ARRAY_SWAP, function (state, _ref10) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, ARRAY_UNSHIFT, function (state, _ref11) {
    var field = _ref11.meta.field,
        payload = _ref11.payload;

    return arraySplice(state, field, 0, 0, payload);
  }), _defineProperty$5(_behaviors, AUTOFILL, function (state, _ref12) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, BLUR, function (state, _ref13) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, CHANGE, function (state, _ref14) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, CLEAR_SUBMIT, function (state) {
    return deleteIn(state, 'triggerSubmit');
  }), _defineProperty$5(_behaviors, CLEAR_SUBMIT_ERRORS, function (state) {
    var result = state;
    result = deleteInWithCleanUp(result, 'submitErrors');
    result = deleteIn(result, 'error');
    return result;
  }), _defineProperty$5(_behaviors, CLEAR_ASYNC_ERROR, function (state, _ref15) {
    var field = _ref15.meta.field;

    return deleteIn(state, 'asyncErrors.' + field);
  }), _defineProperty$5(_behaviors, CLEAR_FIELDS, function (state, _ref16) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, FOCUS, function (state, _ref17) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, INITIALIZE, function (state, _ref18) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, REGISTER_FIELD, function (state, _ref19) {
  ...
  }), _defineProperty$5(_behaviors, RESET, function (state) {
    var result = empty;
    var registeredFields = getIn(state, 'registeredFields');
    if (registeredFields) {
      result = setIn(result, 'registeredFields', registeredFields);
    ...
    return result;
  }), _defineProperty$5(_behaviors, RESET_SECTION, function (state, _ref20) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, SUBMIT, function (state) {
    return setIn(state, 'triggerSubmit', true);
  }), _defineProperty$5(_behaviors, START_ASYNC_VALIDATION, function (state, _ref21) {
    var field = _ref21.meta.field;

    return setIn(state, 'asyncValidating', field || true);
  }), _defineProperty$5(_behaviors, START_SUBMIT, function (state) {
    return setIn(state, 'submitting', true);
  }), _defineProperty$5(_behaviors, STOP_ASYNC_VALIDATION, function (state, _ref22) {
    ...
    if (payload && Object.keys(payload).length) {
      var _error = payload._error,
          fieldErrors = _objectWithoutProperties$b(payload, ['_error']);
    ...
    return result;
  }), _defineProperty$5(_behaviors, STOP_SUBMIT, function (state, _ref23) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, SET_SUBMIT_FAILED, function (state, _ref24) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, SET_SUBMIT_SUCCEEDED, function (state) {
    var result = state;
    result = deleteIn(result, 'submitFailed');
    result = setIn(result, 'submitSucceeded', true);
    return result;
  }), _defineProperty$5(_behaviors, TOUCH, function (state, _ref25) {
    ...
    result = setIn(result, 'anyTouched', true);
    return result;
  }), _defineProperty$5(_behaviors, UNREGISTER_FIELD, function (state, _ref26) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, UNTOUCH, function (state, _ref27) {
    ...
    result = anyTouched ? setIn(result, 'anyTouched', true) : deleteIn(result, 'anyTouched');
    return result;
  }), _defineProperty$5(_behaviors, UPDATE_SYNC_ERRORS, function (state, _ref28) {
    ...
    return result;
  }), _defineProperty$5(_behaviors, UPDATE_SYNC_WARNINGS, function (state, _ref29) {
...
var createValues$1 = function createValues(_ref) {
  ...
  return function (config) {
    var _prop$getFormState$co = _extends$l({
      prop: 'values',
      getFormState: function getFormState(state) {
        return getIn(state, 'form');
      }
    ...
    return connect(function (state) {
      return _defineProperty$6({}, prop, getIn(getFormState(state), form + '.values'));
    }
    // ignore dispatch
    );
  };
...
var ButtonGroup = styled.div(_templateObject2$2);

var Button = styled.button(_templateObject3$2, function (props) {
  return props.disabled ? '#cccccc' : 'palevioletred';
}, function (props) {
  return props.disabled ? '#666666' : 'white';
}, function (props) {
  return props.disabled ? '2px solid #999999' : '2px solid palevioletred';
});
var leftColumnId = '1';
var rightColumnId = '2';

var getItems = function getItems(columns, items, columnId) {
  if (columns[columnId] !== undefined && columns[columnId].selectedItemIds !== undefined && items !== undefined) {
    return columns[columnId].selectedItemIds.map(function (itemId) {
      return items[itemId];
    });
  } else {
    return null;
...
var PickList = function (_Component) {
  inherits$1(PickList, _Component);
  ...
  function PickList() {
    ...
    classCallCheck$1(this, PickList);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = PickList.__proto__ || Object.getPrototypeOf(PickList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      items: _this.props.items,
      columns: {
        '1': _extends$6({}, _this.props.leftColumn, {
          id: '1'
        }),
        '2': _extends$6({}, _this.props.rightColumn, {
          id: '2'
        })
      },
      selectedItemIds: [],
      ...
      var selected = _this.state.selectedItemIds.find(function (itemId) {
        return itemId === id;
      });
      ...
      _this.setState({ draggingItemId: start.draggableId });
    }, _this.onDragEnd = function (result, announce, outSelectedIds) {
      var destination = result.destination;
      var source = result.source;

      // nothing to do
      if (!destination || result.reason === 'CANCEL') {
        _this.setState({ draggingItemId: null });
        return;
      }

      var processed = mutliDragAwareReorder({
        items: _this.state.items,
        columns: _this.state.columns,
        selectedItemIds: outSelectedIds !== undefined ? outSelectedIds : _this.state.selectedItemIds,
        source: source,
        destination: destination
      });

      _this.setState(_extends$6({}, processed, {
        draggingItemId: null
      }));
      _this.controlSelectedItems(_this.state.selectedItemIds);
      ...
      _this.unSelectAll();
    }, _this.onWindowTouchEnd = function (event) {
      if (event.defaultPrevented) {
        return;
      }
      _this.unSelectAll();
    }, _this.controlSelectedItems = function (selectedItemIds) {
      var isRightAllActive = _this.state.columns[leftColumnId].selectedItemIds.length > 0;
      var isLeftAllActive = _this.state.columns[rightColumnId].selectedItemIds.length > 0;

      var isRightActive = false;
      var isLeftActive = false;

      selectedItemIds.map(function (id) {
        if (_this.state.columns[leftColumnId].selectedItemIds.includes(id)) {
          isRightActive = true;
        }
      });

      selectedItemIds.map(function (id) {
        if (_this.state.columns[rightColumnId].selectedItemIds.includes(id)) {
          isLeftActive = true;
        }
      });

      _this.setState({
        isRightAllActive: isRightAllActive,
        isLeftAllActive: isLeftAllActive,
        isRightActive: isRightActive,
        isLeftActive: isLeftActive
      });

      _this.props.dispatch(change$2(_this.props.formId, _this.props.name, _this.state.columns[rightColumnId].selectedItemIds));
    }, _this.toggleSelection = function (itemId) {
      var selectedItemIds = _this.state.selectedItemIds;
      var wasSelected = selectedItemIds.includes(itemId);
      ...
      _this.setState({ selectedItemIds: newItemIds });
      _this.controlSelectedItems(newItemIds);
    }, _this.toggleSelectionInGroup = function (itemId) {
      var selectedItemIds = _this.state.selectedItemIds;
      var index = selectedItemIds.indexOf(itemId);

      // if not selected - add it to the selected items
      var newSelectedIds = [].concat(toConsumableArray(selectedItemIds), [itemId]);
      if (index === -1) {
        _this.setState({ selectedItemIds: newSelectedIds });
        _this.controlSelectedItems(newSelectedIds);
        return;
      }

      // it was previously selected and now needs to be removed from the group
      var shallow = [].concat(toConsumableArray(selectedItemIds));
      shallow.splice(index, 1);
      _this.setState({ selectedItemIds: shallow });
      _this.controlSelectedItems(shallow);
    }, _this.multiSelectTo = function (newItemId) {
      var updated = multiSelectTo(_this.state.columns, _this.state.selectedItemIds, newItemId);

      if (updated == null) {
        return;
      }

      _this.setState({ selectedItemIds: updated });
      _this.controlSelectedItems(updated);
    }, _this.unSelectAll = function () {
      _this.setState({ selectedItemIds: [] });
      _this.controlSelectedItems([]);
    }, _this.onRightButtonPressed = function () {
      var rightButtonPressedResult = {
        draggableId: "0",
        reason: "DROP",
        type: "DEFAULT",
        destination: {
          index: _this.state.columns[rightColumnId].selectedItemIds.length,
      ...
      _this.onDragEnd(rightButtonPressedResult);
    }, _this.onRightAllButtonPressed = function () {
      var rightButtonPressedResult = {
        draggableId: "0",
        reason: "DROP",
        type: "DEFAULT",
      ...
      var outSelectedIds = _this.state.columns[leftColumnId].selectedItemIds;
      _this.onDragEnd(rightButtonPressedResult, null, outSelectedIds);
    }, _this.onLeftButtonPressed = function () {
      var leftButtonPressedResult = {
        draggableId: "0",
        reason: "DROP",
        type: "DEFAULT",
        destination: {
          index: _this.state.columns[leftColumnId].selectedItemIds.length,
          droppableId: leftColumnId
        },
        source: {
          index: 0,
      ...
      _this.onDragEnd(leftButtonPressedResult);
    }, _this.onLeftAllButtonPressed = function () {
      var leftButtonPressedResult = {
        draggableId: "0",
        reason: "DROP",
        type: "DEFAULT",
      ...
      var outSelectedIds = _this.state.columns[rightColumnId].selectedItemIds;
      _this.onDragEnd(leftButtonPressedResult, null, outSelectedIds);
    }, _temp), possibleConstructorReturn$1(_this, _ret);
  }

  createClass$1(PickList, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.items !== undefined && nextProps.leftColumn !== undefined && nextProps.rightColumn !== undefined) {
        this.setState(_extends$6({}, this.state, {
          items: nextProps.items,
          columns: _extends$6({}, this.state.columns, {
            '1': _extends$6({}, nextProps.leftColumn, {
              id: '1'
            }),
            '2': _extends$6({}, nextProps.rightColumn, {
              id: '2'
            })
          })
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              Button,
              { onClick: this.onRightButtonPressed, disabled: !this.state.isRightActive },
              '>'
            ),
            React__default.createElement(
              Button,
              { onClick: this.onRightAllButtonPressed, disabled: !this.state.isRightAllActive },
              '>>'
            ),
            '---',
            React__default.createElement(
              Button,
              { onClick: this.onLeftAllButtonPressed, disabled: !this.state.isLeftAllActive },
              '<<'
            ),
            React__default.createElement(
              Button,
              { onClick: this.onLeftButtonPressed, disabled: !this.state.isLeftActive },
              '<'
            )
          ),
          React__default.createElement(Column, {
